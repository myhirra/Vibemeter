...
const zh: Messages = {
  ...
  'dashboard.toolGemini': 'Gemini',
  'dashboard.toolGLM': 'GLM',
  'dashboard.toolOpencode': 'Opencode',
  'dashboard.toolQoder': 'Qoder',
  ...
  'card.total.prompts': 'Prompt 数',
  'card.total.promptsHint': '平均 {n} tokens / prompt',
  'card.total.value': '价值',
  ...
  'recap.action.copyCaption': '复制文案',
  'recap.action.copiedCaption': '文案已复制（含链接）',
  ...
  // ── Project ROI card (Phase 3) ────────────────────────────────────────
  'card.roi.title': '项目 ROI',
  'card.roi.subtitle': '{project} · {window}',
  'card.roi.allProjects': '全部项目',
  'card.roi.window7d': '近 7 天',
  'card.roi.window30d': '近 30 天',
  'card.roi.empty': '本窗口内还没有数据',
  'card.roi.untaggedExcluded': '{n} 条未分类已排除',
  'card.roi.noSignal': '数据不足',
  'card.roi.shipRate': '发布率',
  'card.roi.shipRateHint': '在已分类会话里成功落地的比例',
  'card.roi.reworkRate': '返工率',
  'card.roi.reworkRateHint': '30 分钟内同一项目重启的比例',
  'card.roi.momentum': '势能',
  'card.roi.momentumHint': '本周会话 / 前 3 周均值',
  'card.roi.momentumAccelerating': '加速',
  'card.roi.momentumSteady': '平稳',
  'card.roi.momentumCooling': '降温',
  'card.roi.focus': '本周专注度',
  'card.roi.focusHint': '会话越集中在少数项目，分数越高',
  'card.roi.focusFocused': '专注',
  'card.roi.focusBalanced': '均衡',
  'card.roi.focusScattered': '分散',
  'card.roi.outputPerDollar': '每美元产出',
  'card.roi.outputPerDollarHint': '{commits} 提交 / $ · {ships} 发布 / $',
  'card.roi.outputPerDollarShort': '{commits}/$',
  ...
  'alerts.addRuleVendor': '+ 官方重置',
  'alerts.addRuleBudget': '+ 预算',
  'alerts.kindBudget': '预算',
  'alerts.budgetPeriod': '周期',
  'alerts.budgetAmount': '预算',
  'alerts.budgetPeriod.today': '今日',
  'alerts.budgetPeriod.7d': '近 7 天',
  'alerts.budgetPeriod.month': '本月',
  ...
  'alerts.kindVendor': '官方重置',
  'alerts.vendorMinBefore': '归零前',
  'alerts.vendorMaxAfter': '归零阈值',
  'alerts.enabled': '启用',
  'alerts.metric': '指标',
  'alerts.below': '低于',
  ...
  'ann.dismiss': '关闭',
  'ann.source': '出处',
  'ann.moreCount': '还有 {n} 条 →',
  'ann.collapse': '收起',
  'ann.kind.quota_reset': '额度重置',
  'ann.kind.outage': '故障',
  'ann.kind.pricing': '定价变化',
  'ann.kind.model': '模型更新',
  'ann.kind.other': '情报',
  'ann.in': '{rel}后',
  'ann.now': '马上',
  'ann.prefs.title': '情报通知',
  'ann.prefs.subtitle': '重要的平台变化 / 额度重置 / 故障会通知到这里。可选择发到系统通知或 webhook 通道。',
  'ann.prefs.urgentSystem': 'urgent → 系统通知',
  'ann.prefs.urgentLocked': '始终通知',
  'ann.prefs.urgentWebhook': 'urgent → Webhook（企业微信 / Bark / 通用）',
  'ann.prefs.warnSystem': 'warn → 系统通知',
  'ann.prefs.warnWebhook': 'warn → Webhook',
  'ann.prefs.permissionLabel': '浏览器通知',
  'ann.prefs.permissionGranted': '已授权',
  'ann.prefs.permissionDenied': '被拒绝 — 请到系统通知设置里开启',
  'ann.prefs.permissionDefault': '未授权',
  'ann.prefs.permissionUnsupported': '浏览器不支持',
  'ann.prefs.enableSystem': '启用通知',
  'ann.prefs.noChannelHint': '尚未配置 webhook 通道 — 上面新增一个，warn / urgent 才能推到群。',
};
...
const en: Messages = {
  ...
  'card.total.tokensHint': 'Claude Code + Codex',
  'card.total.prompts': 'Prompts',
  'card.total.promptsHint': 'avg {n} tokens / prompt',
  ...
  'recap.action.copyCaption': 'Copy caption',
  'recap.action.copiedCaption': 'Caption copied (with link)',
  ...
  // ── Project ROI card (Phase 3) ────────────────────────────────────────
  'card.roi.title': 'Project ROI',
  'card.roi.subtitle': '{project} · {window}',
  'card.roi.allProjects': 'All projects',
  'card.roi.window7d': 'this week',
  'card.roi.window30d': '30d',
  'card.roi.empty': 'No data in this window yet',
  'card.roi.untaggedExcluded': '{n} untagged excluded',
  'card.roi.noSignal': 'No signal',
  'card.roi.shipRate': 'Ship Rate',
  'card.roi.shipRateHint': 'Tagged sessions that landed in main',
  'card.roi.reworkRate': 'Rework Rate',
  'card.roi.reworkRateHint': 'Sessions restarting < 30 min after the prior one',
  'card.roi.momentum': 'Momentum',
  'card.roi.momentumHint': 'This week vs. trailing 3-week average',
  'card.roi.momentumAccelerating': 'accelerating',
  'card.roi.momentumSteady': 'steady',
  'card.roi.momentumCooling': 'cooling',
  'card.roi.focus': 'Focus this week',
  'card.roi.focusHint': 'Higher = sessions concentrated in fewer projects',
  'card.roi.focusFocused': 'focused',
  'card.roi.focusBalanced': 'balanced',
  'card.roi.focusScattered': 'scattered',
  'card.roi.outputPerDollar': 'Output / $',
  'card.roi.outputPerDollarHint': '{commits} commits/$ · {ships} ships/$',
  'card.roi.outputPerDollarShort': '{commits}/$',
  ...
  'alerts.addRuleVendor': '+ Vendor reset',
  'alerts.addRuleBudget': '+ Budget',
  'alerts.kindBudget': 'budget',
  'alerts.budgetPeriod': 'Period',
  'alerts.budgetAmount': 'Budget',
  'alerts.budgetPeriod.today': 'Today',
  'alerts.budgetPeriod.7d': 'Last 7d',
  'alerts.budgetPeriod.month': 'This month',
  ...
  'alerts.kindVendor': 'vendor reset',
  'alerts.vendorMinBefore': 'min before',
  'alerts.vendorMaxAfter': 'zero ≤',
  ...
  'ann.dismiss': 'Dismiss',
  'ann.source': 'Source',
  'ann.moreCount': '{n} more →',
  'ann.collapse': 'Collapse',
  'ann.kind.quota_reset': 'Quota reset',
  'ann.kind.outage': 'Outage',
  'ann.kind.pricing': 'Pricing change',
  'ann.kind.model': 'Model update',
  'ann.kind.other': 'Heads up',
  'ann.in': 'in {rel}',
  'ann.now': 'now',
  'ann.prefs.title': 'Intel notifications',
  'ann.prefs.subtitle': 'Major platform changes / quota resets / outages land here. Choose where they get pushed.',
  'ann.prefs.urgentSystem': 'urgent → system notification',
  'ann.prefs.urgentLocked': 'always on',
  'ann.prefs.urgentWebhook': 'urgent → webhook (WX Work / Bark / generic)',
  'ann.prefs.warnSystem': 'warn → system notification',
  'ann.prefs.warnWebhook': 'warn → webhook',
  'ann.prefs.permissionLabel': 'Browser notification',
  'ann.prefs.permissionGranted': 'granted',
  'ann.prefs.permissionDenied': 'denied — enable in system notification settings',
  'ann.prefs.permissionDefault': 'not yet enabled',
  'ann.prefs.permissionUnsupported': 'unsupported in this browser',
  'ann.prefs.enableSystem': 'Enable',
  'ann.prefs.noChannelHint': 'No webhook channel configured — add one above so warn / urgent can fan out.',
};
